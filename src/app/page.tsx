    ...
    <div className="min-h-screen bg-white taiko-mode:!bg-[#C2185B]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-16 pb-24 text-center">
          {/* Hero Title */}
          <div className="mb-12">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 taiko-mode:text-white mb-6 leading-tight">
              Taiko
              <span className="block text-[#C2185B] taiko-mode:text-white">
                Blockchain Explorer
              </span>
            </h1>
            <p className="text-xl text-gray-600 taiko-mode:text-white/90 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              {/* Total Blocks Card */}
              <div className="group relative bg-white taiko-mode:bg-white/20 taiko-mode:backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100 taiko-mode:border-white/30 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    <div className="text-4xl font-bold text-gray-900 taiko-mode:text-white mb-2">
                      {statsLoading ? (
                        ...
                        <span style={{ color: '#C2185B' }} className="taiko-mode:!text-white">
                          {(statsData?.stats?.totalBlocks || 0).toLocaleString()}
                        </span>
                      )}
                    </div>
                    <p className="text-lg font-medium text-gray-600 taiko-mode:text-white/90 mb-4">Total Blocks</p>
                    <p className="text-sm text-gray-500 taiko-mode:text-white/70">All blocks mined on the network</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white taiko-mode:bg-white/20 taiko-mode:backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100 taiko-mode:border-white/30 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-lg font-medium text-gray-600 taiko-mode:text-white/90 mb-4">Total Transactions</p>
                    <p className="text-sm text-gray-500 taiko-mode:text-white/70">All transactions processed</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/blocks">
                <button className="group flex items-center gap-3 bg-[#C2185B] hover:bg-[#A1165C] taiko-mode:bg-white taiko-mode:text-[#C2185B] taiko-mode:hover:bg-gray-100 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <div className="mt-12 flex items-center justify-center gap-2 text-sm text-gray-600 taiko-mode:text-white/90">
              <div className="w-3 h-3 bg-[#C2185B] taiko-mode:bg-white rounded-full animate-pulse"></div>
              <span>Network Status: Active</span>
              <div className="ml-4 flex items-center gap-1">
                <TrendingUpIcon className="h-4 w-4 text-[#C2185B] taiko-mode:text-white" />
